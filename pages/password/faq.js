...
const GoogleAdUnit = ({ size, placement, responsive = false }) => {
  ...
  const getAdStyles = () => {
    switch(placement) {
      ...
      case 'faqSidebar':
        return 'ad-faq-sidebar bg-slate-800/80 backdrop-blur-sm rounded-xl p-4 shadow-lg sticky top-8';
      case 'contentInline':
        return 'ad-content-inline my-12 bg-gradient-to-br from-slate-800 to-slate-700 rounded-xl p-6 text-center shadow-lg border border-slate-600/30';
      case 'bottomBanner':
              ...
              <div className={ADSENSE_ENABLED ? "col-span-12 xl:col-span-8" : "w-full"}>
                <div className={ADSENSE_ENABLED ? "max-w-6xl mx-auto space-y-8" : "space-y-8"}>
                  ...
                  <div className="mb-8 animate-slide-up">
                    <Link 
                      href="/password"
                      className="inline-flex items-center px-4 py-2 bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-md hover:shadow-lg text-slate-200 hover:text-white font-medium transition-all duration-300 transform hover:scale-105 border border-slate-600/50"
                    >
                    ...
                    <div className={ADSENSE_ENABLED ? "lg:col-span-3" : "w-full"}>
                      <div className="bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 md:p-12 border border-slate-600/50 animate-slide-up">
                        <div className="space-y-8">
                          ...
                          {/* FAQ Item 1 */}
                          <div className="faq-item animate-fade-in-delayed border-b border-slate-700 pb-8 hover:bg-slate-700/30 rounded-xl p-6 transition-all duration-300">
                            <h2 className="text-2xl font-medium text-white mb-4 flex items-start space-x-3">
                              <span className="bg-slate-700 text-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-sm font-medium mt-1">1</span>
                              <span>Is it safe to use an online password generator?</span>
                            </h2>
                            <p className="text-lg text-slate-200 leading-relaxed ml-11">
                          ...
                          <div className="faq-item animate-fade-in-delayed border-b border-slate-700 pb-8 hover:bg-slate-700/30 rounded-xl p-6 transition-all duration-300">
                            <h2 className="text-2xl font-medium text-white mb-4 flex items-start space-x-3">
                              <span className="bg-slate-700 text-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-sm font-medium mt-1">2</span>
                          ...
                          <div className="faq-item animate-fade-in-delayed border-b border-slate-700 pb-8 hover:bg-slate-700/30 rounded-xl p-6 transition-all duration-300">
                            <h2 className="text-2xl font-medium text-white mb-4 flex items-start space-x-3">
                              <span className="bg-slate-700 text-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-sm font-medium mt-1">3</span>
                          ...
                          <div className="faq-item animate-fade-in-delayed border-b border-slate-700 pb-8 hover:bg-slate-700/30 rounded-xl p-6 transition-all duration-300">
                            <h2 className="text-2xl font-medium text-white mb-4 flex items-start space-x-3">
                              <span className="bg-slate-700 text-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-sm font-medium mt-1">4</span>
                              <span>What does "exclude ambiguous characters" mean?</span>
                            </h2>
                            <p className="text-lg text-slate-200 leading-relaxed ml-11">
                              Ambiguous characters like <code className="bg-slate-700 px-2 py-1 rounded font-mono text-sm text-slate-200">0</code> (zero), <code className="bg-slate-700 px-2 py-1 rounded font-mono text-sm text-slate-200">O</code> (letter O), <code className="bg-slate-700 px-2 py-1 rounded font-mono text-sm text-slate-200">l</code> (lowercase L), and <code className="bg-slate-700 px-2 py-1 rounded font-mono text-sm text-slate-200">I</code> (uppercase i) can be confused when typing, especially with certain fonts. Excluding them makes passwords easier to type accurately but slightly reduces password strength. Use this option if you frequently type passwords manually.
                            </p>
                          </div>
                          ...
                          <div className="faq-item animate-fade-in-delayed border-b border-slate-700 pb-8 hover:bg-slate-700/30 rounded-xl p-6 transition-all duration-300">
                            <h2 className="text-2xl font-medium text-white mb-4 flex items-start space-x-3">
                              <span className="bg-slate-700 text-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-sm font-medium mt-1">5</span>
                          ...
                          <div className="faq-item animate-fade-in-delayed border-b border-slate-700 pb-8 hover:bg-slate-700/30 rounded-xl p-6 transition-all duration-300">
                            <h2 className="text-2xl font-medium text-white mb-4 flex items-start space-x-3">
                              <span className="bg-slate-700 text-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-sm font-medium mt-1">6</span>
                          ...
                          <div className="faq-item animate-fade-in-delayed border-b border-slate-700 pb-8 hover:bg-slate-700/30 rounded-xl p-6 transition-all duration-300">
                            <h2 className="text-2xl font-medium text-white mb-4 flex items-start space-x-3">
                              <span className="bg-slate-700 text-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-sm font-medium mt-1">7</span>
                              <span>What's the difference between a strong and weak password?</span>
                            </h2>
                            <div className="text-lg text-slate-200 leading-relaxed ml-11 space-y-3">
                              ...
                              <div className="bg-gradient-to-r from-slate-700 to-slate-600 rounded-lg p-4 space-y-2 border border-slate-600">
                                <p><span className="text-slate-300 font-medium">❌ Weak:</span> <code className="bg-slate-800 px-2 py-1 rounded font-mono text-sm text-slate-200">password123</code></p>
                                <p><span className="text-slate-300 font-medium">✅ Strong:</span> <code className="bg-slate-800 px-2 py-1 rounded font-mono text-sm text-slate-200">K9#mX7$nQ2vL8@pR</code></p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="faq-item animate-fade-in-delayed border-b border-slate-700 pb-8 hover:bg-slate-700/30 rounded-xl p-6 transition-all duration-300">
                            <h2 className="text-2xl font-medium text-white mb-4 flex items-start space-x-3">
                              <span className="bg-slate-700 text-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-sm font-medium mt-1">8</span>
                          ...
                          {/* FAQ Item 9 */}
                          <div className="faq-item animate-fade-in-delayed hover:bg-slate-700/30 rounded-xl p-6 transition-all duration-300">
                            <h2 className="text-2xl font-medium text-white mb-4 flex items-start space-x-3">
                              <span className="bg-slate-700 text-slate-200 rounded-full w-8 h-8 flex items-center justify-center text-sm font-medium mt-1">9</span>
                              <span>What should I do if I think my password was compromised?</span>
                            </h2>
                            <div className="text-lg text-slate-200 leading-relaxed ml-11">
                              <p className="mb-3"><strong className="text-white">Act immediately:</strong></p>
                              <ol className="space-y-2 list-decimal list-inside bg-slate-700/50 rounded-lg p-4 border border-slate-600">
                        ...
                        <div className="mt-16 text-center bg-gradient-to-br from-slate-800 to-slate-700 border border-slate-600 rounded-2xl p-8 shadow-lg relative overflow-hidden">
                          <div className="relative z-10">
                            ...
                            <Link 
                              href="/password"
                              className="inline-flex items-center px-8 py-4 bg-slate-700 hover:bg-slate-600 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-slate-400 border border-slate-600"
                            >
